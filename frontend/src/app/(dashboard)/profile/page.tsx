...
const ProfilePage = () => {
    return (
        <div className="profilePage flex flex-col justify-start items-start p-4 sm:p-6 md:p-8 lg:p-10">
            ...
            {/* Top Layer */}
            <div className="topLayer flex flex-col sm:flex-row w-full sm:justify-between sm:items-center mb-6">
            ...
            <div className="flex flex-col w-full bg-gray-400/30 rounded-xl backdrop-blur-md backdrop-brightness-105 p-4 md:p-6 lg:p-8">
                ...
                <div className="detailsSection flex flex-col md:flex-row gap-6">
